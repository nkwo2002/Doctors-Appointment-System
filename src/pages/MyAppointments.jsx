              ...
              <div className=''>
                  {doctors.slice(0,2).map((item, index) => (
                      <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                          <div>
                              <img className='w-32 bg-[#EAEFFF]' src={item.image} alt="" />
                          </div>
                          <div className='flex-1 text-sm text-[#5E5E5E]'>
                              ...
                              <p className=' text-xs mt-1'><span className='text-sm text-[#3C3C3C] font-medium'>Date & Time:</span> 25,July,2025 | 9:00AM</p>
                          </div>
                          <div></div>
                          <div className='flex flex-col gap-2 justify-end text-sm text-center'>
                               ...
                               <button className='sm:min-w-48 py-2 border border-red-500 rounded text-red-500 hover:text-white transition-all duration-300'>Appointment cancelled</button>
                          </div>
                      </div>
                  ))}
              </div>
